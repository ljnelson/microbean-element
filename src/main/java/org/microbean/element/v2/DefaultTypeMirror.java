...
public final class DefaultTypeMirror implements ArrayType, ErrorType, ExecutableType, IntersectionType, NoType, NullType, PrimitiveType, TypeVariable, UnionType, WildcardType {
  ...
  public final TypeMirror getLowerBound() {
    ...
    default:
      return DefaultNullType.INSTANCE; // bottom type, not NONE type
    }
  }
